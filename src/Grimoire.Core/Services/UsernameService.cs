...
namespace Grimoire.Core.Services
{
    public class UsernameService
    {
        ...
        public async Task<string> FetchUsernameAsync(BaseSource source, GrimoireDatabaseContext context = null)
        {
            var username = _botService.GetUsername(source);
...
#pragma warning disable 4014
        public async Task<string> UpdateUsernameCache(BaseSource source, GrimoireDatabaseContext context)
        {
